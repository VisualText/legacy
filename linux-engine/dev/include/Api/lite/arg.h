/*******************************************************************************
Copyright (c) 2001-2003 by Text Analysis International, Inc.
...
public:
   ...
   static bool float1(_TCHAR*,/*DU*/DELTS*&,float&,bool=false);// 04/29/04 AM.
	...
	static bool any1(
				_TCHAR*,/*DU*/DELTS*&,_TCHAR*&,long&,RFASem*&);	// 05/26/02 AM.
	static bool any1(_TCHAR*, /*DU*/ DELTS*&,enum Iargtype &,// 05/29/02 AM.
