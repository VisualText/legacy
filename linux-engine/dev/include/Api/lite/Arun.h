/*******************************************************************************
Copyright © 2000-2003 by Text Analysis International, Inc.
All rights reserved.
********************************************************************************
*
* NAME:	ARUN.H
...
//	static bool micro_feat(NODE *,const ELT *,Nlppp *);			// 05/25/00 AM.
   ...
   // For deaccented matching.                                 // 03/29/05 AM.
	...
	static bool group(Nlppp *, int, int, _TCHAR *);

	// GROUP VARIANTS.														// 04/28/01 AM.
	static bool group(Nlppp*,RFASem*,int,_TCHAR *);					// 04/28/01 AM.
	static bool group(Nlppp*,int,RFASem*,_TCHAR *);					// 04/28/01 AM.
	static bool group(Nlppp*,int,int,RFASem*);						// 04/28/01 AM.
	static bool group(Nlppp*,RFASem*,RFASem*,_TCHAR *);				// 04/28/01 AM.
	static bool group(Nlppp*,RFASem*,int,RFASem*);					// 04/28/01 AM.
	static bool group(Nlppp*,int,RFASem*,RFASem*);					// 04/28/01 AM.
	static bool group(Nlppp*,RFASem*,RFASem*,RFASem*);				// 04/28/01 AM.
...
//////////////
	...
	static _TCHAR *_tcschr(Nlppp*,_TCHAR*,_TCHAR*);							// 01/09/01 AM.
	static _TCHAR *_tcschr(Nlppp*,RFASem*,_TCHAR*);						// 04/28/01 AM.
	static _TCHAR *_tcschr(Nlppp*,_TCHAR*,RFASem*);						// 04/28/01 AM.
	static _TCHAR *_tcschr(Nlppp*,RFASem*,RFASem*);						// 04/28/01 AM.
	...
	static _TCHAR *_tcsrchr(Nlppp*,_TCHAR*,_TCHAR*);							// 01/09/01 AM.
	static _TCHAR *_tcsrchr(Nlppp*,RFASem*,_TCHAR*);						// 05/07/01 AM.
	static _TCHAR *_tcsrchr(Nlppp*,_TCHAR*,RFASem*);						// 05/07/01 AM.
	static _TCHAR *_tcsrchr(Nlppp*,RFASem*,RFASem*);					// 05/07/01 AM.
	...
	static int strspellcompare(Nlppp*,_TCHAR*,_TCHAR*);					// 01/09/01 AM.
	static int strspellcompare(Nlppp*,RFASem*,_TCHAR*);				// 05/07/01 AM.
	static int strspellcompare(Nlppp*,_TCHAR*,RFASem*);				// 05/07/01 AM.
	static int strspellcompare(Nlppp*,RFASem*,RFASem*);			// 05/07/01 AM.
	...
	static void *fnstart(Nlppp*);											// 03/11/02 AM.

	static RFASem *ret(Nlppp*,void*,long);								// 03/11/02 AM.
	static RFASem *ret(Nlppp*,void*,float);							// 03/11/02 AM.
	static RFASem *ret(Nlppp*,void*,_TCHAR*);							// 03/11/02 AM.
	static RFASem *ret(Nlppp*,void*,RFASem*);							// 03/11/02 AM.
