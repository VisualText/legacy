...
# FILE: d:\apps\rez0_2\spec\PostalRoad.pat
# TIME: 17:00:43 11/17/06
@NODES _LINE

@RULES

# Ex:	allee
_PostalRoad <- _xWILD [min=1 max=1 s match=("allee" "alley" "ally" "aly" "anex" "annex" "annx" "anx" "arc"
 ...
 "kys" "la" "lake" "lakes" "land" "landing" "lane" "lanes" "lck" "lcks"
